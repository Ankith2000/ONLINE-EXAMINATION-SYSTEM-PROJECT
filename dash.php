...
<title>ONLINE EXAMINATION SYSTEM-ANANTH AND ANKITH </title>
...
User</a></li>
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=5">Remove Quiz</a></li>                </ul>
  




<li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6">All users</a></li>


<li <?php if(@$_GET['q']==7) echo'class="active"'; ?>><a href="dash.php?q=7">Quizes</a></li>
...
if(@$_GET['q']== 6) 
{
$q=mysqli_query($con,"SELECT * FROM log" )or die('Error223');
echo  '<div class="panel title"><div class="table-responsive">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>College</b></td><td><b>Mobile</b></td></tr>';$c=0;
...
$mob=$row['mob'];}$c++;
echo '<tr>  <td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$email.'</td><td>'.$college.'</td><td>'.$mob.'</td><td>';
}
echo '</table></div></div>';}
...
if(@$_GET['q']== 7) 
{
$q=mysqli_query($con,"SELECT * FROM loog" )or die('Error223');
echo  '<div class="panel title"><div class="table-responsive">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>S.N.</b></td><td><b>Title</b></td><td><b>Total Questions</b></td><td><b>Time</b></td></tr>';$c=0;
...
$q12=mysqli_query($con,"SELECT * FROM loog WHERE title='$e' "  )or die('Error231');
while($row=mysqli_fetch_array($q12) )
{
$title=$row['title'];
$total=$row['total'];
$time=$row['time'];}$c++;
echo '<tr>  <td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$title.'</td><td>'.$total.'</td><td>'.$time.'</td><td>';
}
echo '</table></div></div>';}
